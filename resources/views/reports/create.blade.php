    ...
    <div class="card rounded-2xl p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Buat laporan baru untuk pendapatan atau pengeluaran.</p>
            </div>
        ...
        <form method="POST" action="{{ route('reports.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description"
                          ...
                          placeholder="Masukkan deskripsi laporan (opsional)">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
